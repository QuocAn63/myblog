    ...
    return (
        <div className={cx("wrapper")}>
            <HeadlessTippy
                ...
                offset={[0, 0]}
                render={(attrs) =>
                    <div className={cx("search-result")} tab-index="-1" {...attrs}>
            ...
            >
                <form action="" method="post">
                    <div className={cx("search")}>
                        <input type="text" placeholder="Tìm kiếm bài viết" ref={searchInputRef} value={searchValue} onFocus={() => setShowResult(true)} onChange={e => handleChangeSearchInput(e)} />
